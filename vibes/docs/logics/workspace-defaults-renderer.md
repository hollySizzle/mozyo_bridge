...
Naming note: 入力 YAML は実態として project-level defaults である。Redmine
#11920 / #11921 で primary 名を `project-defaults.yaml` に rename 済み。旧名
`workspace-defaults.yaml` は read-only fallback として残し、新規 write は新名のみ。
