...
> [[logic-coordinator-sublane-development-flow]] である。本 doc は Redmine
> #11850 以降の観測事実、運用哲学、履歴詳細を残す互換参照であり、
> dispatch / callback / review / close / integration / retirement の
> 別個の完全な規約本文としては扱わない。判断が分岐する場合は
...
である (上の `### サブレーン Claude`)。main Claude は自前の implementation lane を
...
## Redmine task の subject / description 分離 (#11856)
