...
Redmine #12633 / Version #268 `v0.10.22 OOP-first architecture / static typing`.
...
したがって v0.10.22 以降の architecture work は **OOP-first** を基本方針にする。
...
v0.10.22 以降の実装 tranche では、まず巨大 orchestration surface を object boundary に分ける。
候補は次の順で扱う。
...
mozyo_bridge は v0.10.22 以降、architecture work の基本姿勢を OOP-first とする。
