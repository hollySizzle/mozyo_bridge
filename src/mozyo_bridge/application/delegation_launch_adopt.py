...
:mod:`mozyo_bridge.features.execution_platform.delegated_coordinator_nested_handoff.application.delegation_launch_adopt`.
...
(#12591 j#65435). The legacy import path ``mozyo_bridge.application.delegation_launch_adopt`` is
