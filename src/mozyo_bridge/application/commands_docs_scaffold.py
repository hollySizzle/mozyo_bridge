...
:mod:`mozyo_bridge.e_130_governance_distribution.f_140_rules_docs_catalog.application.commands_docs_scaffold`.
...
``application/`` package into the Epic-slug package
``features/governance_distribution/``. The #12622 Redmine-numbered layout
correction (child task #12626) then relocated them to the numbered Epic/Feature
package ``e_130_governance_distribution/f_140_rules_docs_catalog/application/``
...
``mozyo_bridge.e_130_governance_distribution.f_140_rules_docs_catalog.application.commands_docs_scaffold``
