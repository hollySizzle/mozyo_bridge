...
:mod:`mozyo_bridge.features.governance_distribution.application.cli_release`.
...
and into the Redmine Epic-slug package
...
``mozyo_bridge.application.cli_release`` and the new
``mozyo_bridge.features.governance_distribution.application.cli_release`` refer to
