...
:mod:`mozyo_bridge.e_120_operations_cockpit.f_120_cockpit_web_ui.application.cockpit_payload`.
...
``mozyo_bridge.application.cockpit_payload`` and the new numbered path refer to the exact same
