...
def evaluate_herdr_section(view: HerdrInventoryView) -> Optional[dict[str, Any]]:
...
class HerdrSectionUseCase:
    ...
    def __init__(self, reads: HerdrDoctorReads) -> None:
        self._reads = reads

    def execute(self) -> Optional[dict[str, Any]]:
        return evaluate_herdr_section(self._reads.describe())
