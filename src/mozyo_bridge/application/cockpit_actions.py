...
:mod:`mozyo_bridge.e_120_operations_cockpit.f_130_cockpit_actions_preflight.application.cockpit_actions`.
...
Epic/Feature layout ``e_120_operations_cockpit/f_130_cockpit_actions_preflight/application/`` (#12623 migration map). The real
...
``mozyo_bridge.application.cockpit_actions`` and the new numbered path refer to the exact same
...
from mozyo_bridge.e_120_operations_cockpit.f_130_cockpit_actions_preflight.application import (
    cockpit_actions as _impl,
)
