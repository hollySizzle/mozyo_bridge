...
:mod:`mozyo_bridge.features.operations_cockpit.application.cockpit_actions`.
...
Epic #12502). The cockpit side-effecting action endpoints + preflight bridge moved out of the technical-layer ``application/`` package into
...
``mozyo_bridge.application.cockpit_actions`` and the new
``mozyo_bridge.features.operations_cockpit.application.cockpit_actions`` refer to the exact same
