...
:mod:`mozyo_bridge.e_110_execution_platform.f_150_runtime_observation_event_timeline.application.commands_otel`.
...
``mozyo_bridge.application.commands_otel`` and the new path refer to the exact same module object —
