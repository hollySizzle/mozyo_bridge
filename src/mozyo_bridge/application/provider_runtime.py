...
:mod:`mozyo_bridge.e_140_adapter_provider.f_160_provider_registry.application.provider_runtime`.

US #12627 (parent US #12622, Redmine Epic #12504 `140_Adapter・Provider基盤`) re-homes
the provider registry runtime to the Redmine-numbered Feature package ``src/mozyo_bridge/e_140_adapter_provider/f_160_provider_registry/application/`` (Feature #12529
`160_ProviderRegistry`), superseding the #12595 ``features/adapter_provider/`` epic-slug pilot
...
``mozyo_bridge.application.provider_runtime`` is preserved; the relocated module object is re-bound here via
