...
:mod:`mozyo_bridge.features.adapter_provider.application.provider_runtime`.

US #12595 (parent US #12590) moved the provider registry runtime out of the
...
j#65435). The legacy import path ``mozyo_bridge.application.provider_runtime`` is
preserved per ``vibes/docs/logics/source-layout-bounded-context-migration.md``;
