...
from mozyo_bridge.e_140_adapter_provider.f_130_terminal_runtime_provider.domain.default_agent_topology import DEFAULT_EXPECTED_AGENTS  # noqa: E501
...
def build_mozyo_json_payload(
    *,
    ...
    return {
        ...
        "windows": windows,
        "ready": set(DEFAULT_EXPECTED_AGENTS).issubset(present),
...
class MozyoLaunchUseCase:
    ...
    def run(self, args: argparse.Namespace) -> MozyoLaunchOutcome:
        ...
        refusal = adoption_refusal(
            repo_root,
            ops.adoption_marker(repo_root),
            nested=ops.nested_adoption_marker(repo_root),
        )
