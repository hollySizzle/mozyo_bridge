...
:mod:`mozyo_bridge.e_110_execution_platform.f_140_delegated_coordinator_nested_handoff.application.cli_handoff_grandchild_realization`.
...
``src/mozyo_bridge/e_110_execution_platform/f_140_delegated_coordinator_nested_handoff/application/`` per the reviewed migration
...
``mozyo_bridge.application.cli_handoff_grandchild_realization`` and the new path refer to the exact same module object —
...
from mozyo_bridge.e_110_execution_platform.f_140_delegated_coordinator_nested_handoff.application import (
    cli_handoff_grandchild_realization as _impl,
)
