...
:mod:`mozyo_bridge.e_110_execution_platform.f_160_state_store_managed_events.application.commands_state`.
...
``src/mozyo_bridge/e_110_execution_platform/f_160_state_store_managed_events/application/`` per the reviewed migration
...
``mozyo_bridge.application.commands_state`` and the new path refer to the exact same module object —
...
from mozyo_bridge.e_110_execution_platform.f_160_state_store_managed_events.application import (
    commands_state as _impl,
)
