...
:mod:`mozyo_bridge.features.operations_cockpit.application.grouped_detail`.
...
Epic #12502). The cockpit grouped detail view moved out of the technical-layer ``application/`` package into
...
``mozyo_bridge.application.grouped_detail`` and the new
``mozyo_bridge.features.operations_cockpit.application.grouped_detail`` refer to the exact same
