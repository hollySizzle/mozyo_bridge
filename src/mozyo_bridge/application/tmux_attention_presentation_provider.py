...
:mod:`mozyo_bridge.e_120_operations_cockpit.f_150_attention_freshness_projection.application.tmux_attention_presentation_provider`.
...
``mozyo_bridge.application.tmux_attention_presentation_provider`` and the new numbered path refer to the exact same
