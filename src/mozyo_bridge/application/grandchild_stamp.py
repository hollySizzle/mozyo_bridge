...
:mod:`mozyo_bridge.e_110_execution_platform.f_140_delegated_coordinator_nested_handoff.application.grandchild_stamp`.
...
``mozyo_bridge.application.grandchild_stamp`` and the new path refer to the exact same module object —
