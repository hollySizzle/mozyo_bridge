...
:mod:`mozyo_bridge.features.execution_platform.delegated_coordinator_nested_handoff.application.grandchild_stamp`.
...
(#12591 j#65435). The legacy import path ``mozyo_bridge.application.grandchild_stamp`` is
