...
:mod:`mozyo_bridge.features.operations_cockpit.application.text_attention_presentation_provider`.
...
Epic #12502). The text presentation provider for cockpit attention moved out of the technical-layer ``application/`` package into
...
``mozyo_bridge.application.text_attention_presentation_provider`` and the new
``mozyo_bridge.features.operations_cockpit.application.text_attention_presentation_provider`` refer to the exact same
