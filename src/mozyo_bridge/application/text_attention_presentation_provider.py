...
:mod:`mozyo_bridge.e_120_operations_cockpit.f_150_attention_freshness_projection.application.text_attention_presentation_provider`.
...
Epic/Feature layout ``e_120_operations_cockpit/f_150_attention_freshness_projection/application/`` (#12623 migration map). The real
...
``mozyo_bridge.application.text_attention_presentation_provider`` and the new numbered path refer to the exact same
...
from mozyo_bridge.e_120_operations_cockpit.f_150_attention_freshness_projection.application import (
    text_attention_presentation_provider as _impl,
)
