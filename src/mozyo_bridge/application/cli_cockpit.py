...
:mod:`mozyo_bridge.e_120_operations_cockpit.f_120_cockpit_web_ui.application.cli_cockpit`.
...
``mozyo_bridge.application.cli_cockpit`` and the new numbered path refer to the exact same
