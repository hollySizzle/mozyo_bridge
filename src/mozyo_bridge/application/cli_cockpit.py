...
:mod:`mozyo_bridge.features.operations_cockpit.application.cli_cockpit`.
...
Epic #12502). The cockpit CLI subcommands moved out of the technical-layer ``application/`` package into
...
``mozyo_bridge.application.cli_cockpit`` and the new
``mozyo_bridge.features.operations_cockpit.application.cli_cockpit`` refer to the exact same
