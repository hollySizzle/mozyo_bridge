...
:mod:`mozyo_bridge.e_110_execution_platform.f_110_workspace_session_identity.application.cli_workspace`.
...
``mozyo_bridge.application.cli_workspace`` and the new path refer to the exact same module object —
