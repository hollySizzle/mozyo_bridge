...
:mod:`mozyo_bridge.e_120_operations_cockpit.f_150_attention_freshness_projection.application.cli_presentation`.
...
``mozyo_bridge.application.cli_presentation`` and the new numbered path refer to the exact same
