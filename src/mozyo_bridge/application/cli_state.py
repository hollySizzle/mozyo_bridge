...
:mod:`mozyo_bridge.e_110_execution_platform.f_160_state_store_managed_events.application.cli_state`.
...
``mozyo_bridge.application.cli_state`` and the new path refer to the exact same module object —
