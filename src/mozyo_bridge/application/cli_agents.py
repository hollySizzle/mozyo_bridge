...
:mod:`mozyo_bridge.e_110_execution_platform.f_120_agent_discovery_pane_resolution.application.cli_agents`.
...
``src/mozyo_bridge/e_110_execution_platform/f_120_agent_discovery_pane_resolution/application/`` per the reviewed migration
...
``mozyo_bridge.application.cli_agents`` and the new path refer to the exact same module object —
