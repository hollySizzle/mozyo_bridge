...
:mod:`mozyo_bridge.features.governance_distribution.application.cli_docs_scaffold`.
...
``mozyo_bridge.features.governance_distribution.application.cli_docs_scaffold``
