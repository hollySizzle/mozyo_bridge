...
:mod:`mozyo_bridge.e_120_operations_cockpit.f_150_attention_freshness_projection.application.attention_projection`.
...
``mozyo_bridge.application.attention_projection`` and the new numbered path refer to the exact same
