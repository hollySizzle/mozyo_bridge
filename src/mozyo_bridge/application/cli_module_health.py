...
:mod:`mozyo_bridge.e_150_quality_architecture.f_130_module_health.application.cli_module_health`.

#12628 (parent US #12622, Feature #12533 `140_ソース配置管理`) moved the
``mozyo-bridge health`` CLI parser registration into the Redmine-numbered Epic/Feature
package ``e_150_quality_architecture/f_130_module_health/application/`` (Epic #12505
...
``sys.modules`` so that ``mozyo_bridge.application.cli_module_health`` and the new
``mozyo_bridge.e_150_quality_architecture.f_130_module_health.application.cli_module_health``
