...
:mod:`mozyo_bridge.e_110_execution_platform.f_130_handoff_routing.application.cli_handoff`.
...
``src/mozyo_bridge/e_110_execution_platform/f_130_handoff_routing/application/`` per the reviewed migration
...
``mozyo_bridge.application.cli_handoff`` and the new path refer to the exact same module object —
