...
:mod:`mozyo_bridge.features.operations_cockpit.application.cockpit_ui`.
...
Epic #12502). The served cockpit Web UI facade (page / payload / actions split) moved out of the technical-layer ``application/`` package into
...
``mozyo_bridge.application.cockpit_ui`` and the new
``mozyo_bridge.features.operations_cockpit.application.cockpit_ui`` refer to the exact same
