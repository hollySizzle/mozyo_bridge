...
# The read-side authority verdicts moved to their own companion module (Redmine
# #15712 module-health split); the import below keeps every historical import path
# (`from mozyo_bridge.core.state.herdr_launch_generation import verified_generation_token`)
# working unchanged.
from mozyo_bridge.core.state.herdr_launch_generation_authority import (  # noqa: E402
