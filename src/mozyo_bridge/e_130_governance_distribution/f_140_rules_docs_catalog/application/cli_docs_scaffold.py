...
def register(sub) -> None:
    ...
    scaffold_apply.add_argument(
        ...
        help=(
            ...
            "Omitted: no config is written and the runtime default applies "
            "(herdr since 2.0, Redmine #15531; declare `tmux` to stay on "
            "tmux). The written config is operator-owned "
