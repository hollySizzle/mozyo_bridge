...
:mod:`mozyo_bridge.core.state.workspace_registry`.
...
mozyo_bridge.workspace_registry and mozyo_bridge.core.state.workspace_registry refer to the
...
from mozyo_bridge.core.state import workspace_registry as _impl
