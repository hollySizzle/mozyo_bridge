...
:mod:`mozyo_bridge.core.state.session_inventory`.
...
mozyo_bridge.session_inventory and mozyo_bridge.core.state.session_inventory refer to the
...
from mozyo_bridge.core.state import session_inventory as _impl
