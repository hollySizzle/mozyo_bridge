...
:mod:`mozyo_bridge.core.state.otel_store`.
...
mozyo_bridge.otel_store and mozyo_bridge.core.state.otel_store refer to the
...
from mozyo_bridge.core.state import otel_store as _impl
