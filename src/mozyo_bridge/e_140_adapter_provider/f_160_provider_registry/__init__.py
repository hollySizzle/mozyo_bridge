...
``mozyo_bridge.e_140_adapter_provider.f_160_provider_registry.domain.provider_registry`` / ``mozyo_bridge.e_140_adapter_provider.f_160_provider_registry.application.provider_runtime``
