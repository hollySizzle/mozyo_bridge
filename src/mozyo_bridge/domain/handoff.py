...
:mod:`mozyo_bridge.e_110_execution_platform.f_130_handoff_routing.domain.handoff`.
...
``mozyo_bridge.domain.handoff`` and the new path refer to the exact same module object —
