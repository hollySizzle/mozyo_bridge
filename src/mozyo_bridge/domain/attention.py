...
:mod:`mozyo_bridge.features.operations_cockpit.domain.attention`.
...
Epic #12502). The conservative cockpit attention-state derivation moved out of the technical-layer ``domain/`` package into
...
``mozyo_bridge.domain.attention`` and the new
``mozyo_bridge.features.operations_cockpit.domain.attention`` refer to the exact same
