...
:mod:`mozyo_bridge.e_120_operations_cockpit.f_150_attention_freshness_projection.domain.attention`.
...
Epic/Feature layout ``e_120_operations_cockpit/f_150_attention_freshness_projection/domain/`` (#12623 migration map). The real
...
``mozyo_bridge.domain.attention`` and the new numbered path refer to the exact same
...
from mozyo_bridge.e_120_operations_cockpit.f_150_attention_freshness_projection.domain import (
    attention as _impl,
)
