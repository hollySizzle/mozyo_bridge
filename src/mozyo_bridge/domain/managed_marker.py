...
:mod:`mozyo_bridge.e_110_execution_platform.f_160_state_store_managed_events.domain.managed_marker`.
...
``src/mozyo_bridge/e_110_execution_platform/f_160_state_store_managed_events/domain/`` per the reviewed migration
...
``mozyo_bridge.domain.managed_marker`` and the new path refer to the exact same module object —
...
from mozyo_bridge.e_110_execution_platform.f_160_state_store_managed_events.domain import (
    managed_marker as _impl,
)
