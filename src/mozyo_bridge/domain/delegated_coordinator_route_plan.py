...
:mod:`mozyo_bridge.e_110_execution_platform.f_140_delegated_coordinator_nested_handoff.domain.delegated_coordinator_route_plan`.
...
``src/mozyo_bridge/e_110_execution_platform/f_140_delegated_coordinator_nested_handoff/domain/`` per the reviewed migration
...
``mozyo_bridge.domain.delegated_coordinator_route_plan`` and the new path refer to the exact same module object —
...
from mozyo_bridge.e_110_execution_platform.f_140_delegated_coordinator_nested_handoff.domain import (
    delegated_coordinator_route_plan as _impl,
)
