...
:mod:`mozyo_bridge.features.execution_platform.delegated_coordinator_nested_handoff.domain.grandchild_stamp`.
...
(#12591 j#65435). The legacy import path ``mozyo_bridge.domain.grandchild_stamp`` is
