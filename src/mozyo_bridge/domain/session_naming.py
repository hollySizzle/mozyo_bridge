...
:mod:`mozyo_bridge.e_110_execution_platform.f_110_workspace_session_identity.domain.session_naming`.
...
``mozyo_bridge.domain.session_naming`` and the new path refer to the exact same module object —
