...
:mod:`mozyo_bridge.e_120_operations_cockpit.f_120_cockpit_web_ui.domain.grouped_reload_view`.
...
Epic/Feature layout ``e_120_operations_cockpit/f_120_cockpit_web_ui/domain/`` (#12623 migration map). The real
...
``mozyo_bridge.domain.grouped_reload_view`` and the new numbered path refer to the exact same
...
from mozyo_bridge.e_120_operations_cockpit.f_120_cockpit_web_ui.domain import (
    grouped_reload_view as _impl,
)
