...
:mod:`mozyo_bridge.e_110_execution_platform.f_120_agent_discovery_pane_resolution.domain.agent_discovery`.
...
``src/mozyo_bridge/e_110_execution_platform/f_120_agent_discovery_pane_resolution/domain/`` per the reviewed migration
...
``mozyo_bridge.domain.agent_discovery`` and the new path refer to the exact same module object —
