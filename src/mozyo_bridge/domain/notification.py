...
:mod:`mozyo_bridge.e_110_execution_platform.f_130_handoff_routing.domain.notification`.
...
``src/mozyo_bridge/e_110_execution_platform/f_130_handoff_routing/domain/`` per the reviewed migration
...
``mozyo_bridge.domain.notification`` and the new path refer to the exact same module object —
