...
:mod:`mozyo_bridge.features.operations_cockpit.domain.cockpit_layout`.
...
Epic #12502). The cockpit layout geometry / projection domain moved out of the technical-layer ``domain/`` package into
...
``mozyo_bridge.domain.cockpit_layout`` and the new
``mozyo_bridge.features.operations_cockpit.domain.cockpit_layout`` refer to the exact same
