...
:mod:`mozyo_bridge.e_120_operations_cockpit.f_140_presentation_grouping_layout.domain.cockpit_layout`.
...
``mozyo_bridge.domain.cockpit_layout`` and the new numbered path refer to the exact same
