...
:mod:`mozyo_bridge.e_110_execution_platform.f_120_agent_discovery_pane_resolution.domain.pane_resolver`.
...
``mozyo_bridge.domain.pane_resolver`` and the new path refer to the exact same module object —
