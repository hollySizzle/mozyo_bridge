...
:mod:`mozyo_bridge.e_120_operations_cockpit.f_120_cockpit_web_ui.domain.grouped_display`.
...
``mozyo_bridge.domain.grouped_display`` and the new numbered path refer to the exact same
