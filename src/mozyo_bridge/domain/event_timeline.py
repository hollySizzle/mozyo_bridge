...
:mod:`mozyo_bridge.e_110_execution_platform.f_150_runtime_observation_event_timeline.domain.event_timeline`.
...
``mozyo_bridge.domain.event_timeline`` and the new path refer to the exact same module object —
