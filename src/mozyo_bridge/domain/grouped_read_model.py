...
:mod:`mozyo_bridge.e_120_operations_cockpit.f_110_cockpit_read_model.domain.grouped_read_model`.
...
Epic/Feature layout ``e_120_operations_cockpit/f_110_cockpit_read_model/domain/`` (#12623 migration map). The real
...
``mozyo_bridge.domain.grouped_read_model`` and the new numbered path refer to the exact same
