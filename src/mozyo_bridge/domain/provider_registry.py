...
:mod:`mozyo_bridge.e_140_adapter_provider.f_160_provider_registry.domain.provider_registry`.

US #12627 (parent US #12622, Redmine Epic #12504 `140_Adapter・Provider基盤`) re-homes
the provider registry to the Redmine-numbered Feature package ``src/mozyo_bridge/e_140_adapter_provider/f_160_provider_registry/domain/`` (Feature #12529
...
``mozyo_bridge.domain.provider_registry`` is preserved; the relocated module object is re-bound here via
