...
:mod:`mozyo_bridge.features.operations_cockpit.domain.cockpit_geometry`.
...
Epic #12502). The cockpit geometry domain moved out of the technical-layer ``domain/`` package into
...
``mozyo_bridge.domain.cockpit_geometry`` and the new
``mozyo_bridge.features.operations_cockpit.domain.cockpit_geometry`` refer to the exact same
