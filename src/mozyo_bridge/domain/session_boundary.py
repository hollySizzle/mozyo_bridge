...
:mod:`mozyo_bridge.e_110_execution_platform.f_110_workspace_session_identity.domain.session_boundary`.
...
``src/mozyo_bridge/e_110_execution_platform/f_110_workspace_session_identity/domain/`` per the reviewed migration
...
``mozyo_bridge.domain.session_boundary`` and the new path refer to the exact same module object —
...
from mozyo_bridge.e_110_execution_platform.f_110_workspace_session_identity.domain import (
    session_boundary as _impl,
)
