...
:mod:`mozyo_bridge.e_150_quality_architecture.f_130_module_health.domain.module_health`.

#12628 (parent US #12622, Feature #12533 `140_ソース配置管理`) moved the module-health
metrics + oversized-module gate core into the Redmine-numbered Epic/Feature package
``e_150_quality_architecture/f_130_module_health/domain/`` (Epic #12505
...
``sys.modules`` so that ``mozyo_bridge.domain.module_health`` and the new
``mozyo_bridge.e_150_quality_architecture.f_130_module_health.domain.module_health``
