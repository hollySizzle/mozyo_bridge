...
:mod:`mozyo_bridge.e_110_execution_platform.f_140_delegated_coordinator_nested_handoff.domain.delegation_projection`.
...
``mozyo_bridge.domain.delegation_projection`` and the new path refer to the exact same module object —
...
from mozyo_bridge.e_110_execution_platform.f_140_delegated_coordinator_nested_handoff.domain import (
    delegation_projection as _impl,
)
