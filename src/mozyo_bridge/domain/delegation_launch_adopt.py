...
:mod:`mozyo_bridge.e_110_execution_platform.f_140_delegated_coordinator_nested_handoff.domain.delegation_launch_adopt`.
...
``mozyo_bridge.domain.delegation_launch_adopt`` and the new path refer to the exact same module object —
