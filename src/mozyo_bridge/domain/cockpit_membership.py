...
:mod:`mozyo_bridge.e_120_operations_cockpit.f_110_cockpit_read_model.domain.cockpit_membership`.
...
``mozyo_bridge.domain.cockpit_membership`` and the new numbered path refer to the exact same
