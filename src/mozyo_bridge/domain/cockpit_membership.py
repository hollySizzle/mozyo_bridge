...
:mod:`mozyo_bridge.features.operations_cockpit.domain.cockpit_membership`.
...
Epic #12502). The cockpit membership list / status model moved out of the technical-layer ``domain/`` package into
...
``mozyo_bridge.domain.cockpit_membership`` and the new
``mozyo_bridge.features.operations_cockpit.domain.cockpit_membership`` refer to the exact same
