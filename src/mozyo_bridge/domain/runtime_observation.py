...
:mod:`mozyo_bridge.e_110_execution_platform.f_150_runtime_observation_event_timeline.domain.runtime_observation`.
...
``src/mozyo_bridge/e_110_execution_platform/f_150_runtime_observation_event_timeline/domain/`` per the reviewed migration
...
``mozyo_bridge.domain.runtime_observation`` and the new path refer to the exact same module object —
...
from mozyo_bridge.e_110_execution_platform.f_150_runtime_observation_event_timeline.domain import (
    runtime_observation as _impl,
)
