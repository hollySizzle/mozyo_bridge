...
#   auto_target_repo_unresolved            "aborted before typing; no notification was
#                                          typed" (#14249: `--target-repo auto` could not
#                                          resolve the target's own root and never falls
#                                          back to the sender's, so the route gate `die`s
#                                          before the transport rail exists)
#
