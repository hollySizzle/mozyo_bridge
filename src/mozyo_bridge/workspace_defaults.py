...
:mod:`mozyo_bridge.core.state.workspace_defaults`.
...
mozyo_bridge.workspace_defaults and mozyo_bridge.core.state.workspace_defaults refer to the
...
from mozyo_bridge.core.state import workspace_defaults as _impl
