...
:mod:`mozyo_bridge.features.adapter_provider.infrastructure.redmine_ticket_provider`.

US #12595 (parent US #12590) moved the Redmine ticket provider out of the
...
import path ``mozyo_bridge.infrastructure.redmine_ticket_provider`` is preserved
per ``vibes/docs/logics/source-layout-bounded-context-migration.md``; the relocated
