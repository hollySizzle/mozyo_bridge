...
:mod:`mozyo_bridge.e_140_adapter_provider.f_120_redmine_adapter.infrastructure.redmine_note_transport`.

US #12627 (parent US #12622, Redmine Epic #12504 `140_Adapter・Provider基盤`) re-homes
the Redmine journal note transport to the Redmine-numbered Feature package ``src/mozyo_bridge/e_140_adapter_provider/f_120_redmine_adapter/infrastructure/`` (Feature #12525
...
``mozyo_bridge.infrastructure.redmine_note_transport`` is preserved; the relocated module object is re-bound here via
