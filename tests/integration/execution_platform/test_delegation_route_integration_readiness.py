...
(`tests/unit/execution_platform/test_delegated_coordinator_acceptance_oracle.py`),
...
`tests/integration/execution_platform/`). The `%N` values are synthetic
...
sys.path.insert(0, str(ROOT / "tests" / "unit" / "execution_platform"))
