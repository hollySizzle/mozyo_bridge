...
subjects are ``mozyo_bridge.domain.handoff`` (execution_platform, Epic #12501 / Feature
#12509 HandoffRouting, owned by the #12624 lane) and ``mozyo_bridge.domain.delivery_record_sink``
